...
The OpenShift GitOps Operator installs and configures Argo CD in your cluster.  
Argo CD is a declarative, Kubernetes-native continuous delivery tool that follows the GitOps methodology.  
It continuously monitors one or more Git repositories containing your Kubernetes manifests (or Helm charts, Kustomize overlays, etc.),  
compares the declared desired state in Git against the live state in the cluster,  
and automatically reconciles any differences.
...
## New cluster Installation instructions
