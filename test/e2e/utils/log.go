...
// LogExecutionSummary logs the execution time of all tests stored in the config.Cfg.Test.TestsExecutionTime map.
...
func LogExecutionSummary() {
	...
	for test, duration := range config.Cfg.Test.TestsExecutionTime {
