...
1. **Obtain GABI access and token**:
   ...
   - After access is granted, retrieve your token from the stage cluster: [GABI Assisted Migration (stage)](https://gabi-assisted-migration-stage.apps.crcs02ue1.urby.p1.openshiftapps.com)
