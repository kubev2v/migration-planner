...
echo "   export MIGRATION_PLANNER_ADMIN_GROUP_FILE=\"$SCRIPT_DIR/admin-group.yaml\""
...
echo "   - Admin group is created automatically from: $SCRIPT_DIR/admin-group.yaml at startup"
echo "   - For Partner/Customer groups, run: ./hack/create-groups.sh"
