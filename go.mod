...
require (
	...
	github.com/openshift/assisted-image-service v0.0.0-20250612144112-cf493fc124f9
...
replace (
	github.com/konveyor/forklift-controller => github.com/kubev2v/forklift v0.0.0-20250526103348-5b9a983b7a06
