...
type ClientInterface interface {
	...
	// HeadImage request
	HeadImage(ctx context.Context, id openapi_types.UUID, params *HeadImageParams, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) HeadImage(ctx context.Context, id openapi_types.UUID, params *HeadImageParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewHeadImageRequest(c.Server, id, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewHeadImageRequest(server string, id openapi_types.UUID, params *HeadImageParams) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	HeadImageWithResponse(ctx context.Context, id openapi_types.UUID, params *HeadImageParams, reqEditors ...RequestEditorFn) (*HeadImageResponse, error)
...
func (c *ClientWithResponses) HeadImageWithResponse(ctx context.Context, id openapi_types.UUID, params *HeadImageParams, reqEditors ...RequestEditorFn) (*HeadImageResponse, error) {
	rsp, err := c.HeadImage(ctx, id, params, reqEditors...)
	if err != nil {
		return nil, err
	}
