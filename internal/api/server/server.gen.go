...
type ServerInterface interface {
	...
	HeadImage(w http.ResponseWriter, r *http.Request, id openapi_types.UUID, params HeadImageParams)
...
// (HEAD /api/v1/sources/{id}/image)
func (_ Unimplemented) HeadImage(w http.ResponseWriter, r *http.Request, id openapi_types.UUID, params HeadImageParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) HeadImage(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.HeadImage(w, r, id, params)
	}))
...
// HeadImage operation middleware
func (sh *strictHandler) HeadImage(w http.ResponseWriter, r *http.Request, id openapi_types.UUID, params HeadImageParams) {
