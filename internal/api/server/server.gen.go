...
type ServerInterface interface {
	...
	// (POST /api/v1/assessments/jobs)
	CreateRVToolsJob(w http.ResponseWriter, r *http.Request)
...
// (POST /api/v1/assessments/jobs)
func (_ Unimplemented) CreateRVToolsJob(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// CreateRVToolsJob operation middleware
func (siw *ServerInterfaceWrapper) CreateRVToolsJob(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateRVToolsJob(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/api/v1/assessments/jobs", wrapper.CreateRVToolsJob)
	})
	r.Group(func(r chi.Router) {
...
type CreateRVToolsJobRequestObject struct {
	Body *multipart.Reader
}

type CreateRVToolsJobResponseObject interface {
	VisitCreateRVToolsJobResponse(w http.ResponseWriter) error
}

type CreateRVToolsJob201JSONResponse Job

func (response CreateRVToolsJob201JSONResponse) VisitCreateRVToolsJobResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(201)
...
type CreateRVToolsJob400JSONResponse Error

func (response CreateRVToolsJob400JSONResponse) VisitCreateRVToolsJobResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type CreateRVToolsJob401JSONResponse Error

func (response CreateRVToolsJob401JSONResponse) VisitCreateRVToolsJobResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(401)
...
type CreateRVToolsJob500JSONResponse Error

func (response CreateRVToolsJob500JSONResponse) VisitCreateRVToolsJobResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type StrictServerInterface interface {
	...
	// (POST /api/v1/assessments/jobs)
	CreateRVToolsJob(ctx context.Context, request CreateRVToolsJobRequestObject) (CreateRVToolsJobResponseObject, error)
...
// CreateRVToolsJob operation middleware
func (sh *strictHandler) CreateRVToolsJob(w http.ResponseWriter, r *http.Request) {
	var request CreateRVToolsJobRequestObject
	...
	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.CreateRVToolsJob(ctx, request.(CreateRVToolsJobRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "CreateRVToolsJob")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(CreateRVToolsJobResponseObject); ok {
		if err := validResponse.VisitCreateRVToolsJobResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
