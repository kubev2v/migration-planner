...
type Authz struct {
	AuthorizationEnabled   bool   `envconfig:"MIGRATION_PLANNER_AUTHZ_ENABLED" default:"true"`
	PlatformDefinitionFile bool   `envconfig:"MIGRATION_PLANNER_AUTHZ_PLATFORM_FILE" default:""`
	SpiceDBURL             string `envconfig:"MIGRATION_PLANNER_SPICEDB_URL" default:"localhost:50051"`
	SpiceDBToken           string `envconfig:"MIGRATION_PLANNER_SPICEDB_TOKEN" default:""`
}
