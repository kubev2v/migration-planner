...
type Authz interface {
	...
	DeletetAllRelationships(ctx context.Context, assessmentID string) error
	...
	// Acquires: Global Lock (Exclusive) - writes/deletes relationships to/from SpiceDB.
	DeletetRelationships(ctx context.Context, relationships ...model.Relationship) error
...
func (a *AuthzService) DeletetAllRelationships(ctx context.Context, assessmentID string) error {
	ctx, err := a.s.NewTransactionContext(ctx)
	if err != nil {
		return err
	}
...
// DeletetRelationships removes multiple relationships for an assessment.
// Acquires: Global Lock (Exclusive) - writes/deletes relationships to/from SpiceDB.
func (a *AuthzService) DeletetRelationships(ctx context.Context, relationships ...model.Relationship) error {
	ctx, err := a.s.NewTransactionContext(ctx)
	if err != nil {
		return err
	}
...
func (n *NoopAuthzService) DeletetAllRelationships(ctx context.Context, assessmentID string) error {
	return nil
}

// DeletetRelationships is a no-op implementation that returns nil.
func (n *NoopAuthzService) DeletetRelationships(ctx context.Context, relationships ...model.Relationship) error {
	return nil
}
