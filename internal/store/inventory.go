	...
	return api.Inventory{
		...
		Vms: api.VMs{
			...
			Os: map[string]int{
				...
				"VMware Photon OS (64-bit)":              4,
			},
			OsInfo: map[string]api.OsInfo{
				"Amazon Linux 2 (64-bit)":                {Supported: true},
				"CentOS 7 (64-bit)":                      {Supported: true},
				"CentOS 8 (64-bit)":                      {Supported: true},
				"Debian GNU/Linux 12 (64-bit)":           {Supported: true},
				"FreeBSD (64-bit)":                       {Supported: true},
				"Microsoft Windows 10 (64-bit)":          {Supported: true},
				"Microsoft Windows 11 (64-bit)":          {Supported: true},
				"Microsoft Windows Server 2019 (64-bit)": {Supported: true},
				"Microsoft Windows Server 2022 (64-bit)": {Supported: true},
				"Microsoft Windows Server 2025 (64-bit)": {Supported: true},
				"Other (32-bit)":                         {Supported: true},
				"Other (64-bit)":                         {Supported: true},
				"Other 2.6.x Linux (64-bit)":             {Supported: true},
				"Other Linux (64-bit)":                   {Supported: true},
				"Red Hat Enterprise Linux 8 (64-bit)":    {Supported: true},
				"Red Hat Enterprise Linux 9 (64-bit)":    {Supported: true},
				"Red Hat Fedora (64-bit)":                {Supported: true},
				"Rocky Linux (64-bit)":                   {Supported: true},
				"Ubuntu Linux (64-bit)":                  {Supported: true},
				"VMware ESXi 8.0 or later":               {Supported: true},
				"VMware Photon OS (64-bit)":              {Supported: false},
			},
