...
type RiverJob interface {
	GetJobIDByAssessmentID(ctx context.Context, assessmentID uuid.UUID) (*int64, error)
}
...
// GetJobIDByAssessmentID finds a River job ID by assessmentID in the job args
// Returns nil if no active job is found for the assessment
func (r *RiverJobStore) GetJobIDByAssessmentID(ctx context.Context, assessmentID uuid.UUID) (*int64, error) {
	var jobID int64
